...
const Home: NextPage = () => {
  return (
    <>
      <Head>
        <title>Dieferson - Frontend Developer</title>
        <link rel="icon" href="/code.png" />
        <meta name="author" content="Dieferson Soares" />
        ...
        <title data-rh="true">Dieferson - Frontend Developer</title>
        <meta data-rh="true" property="og:type" content="website"/>
        <meta data-rh="true" property="og:title" content="Dieferson - Frontend Developer"/>
